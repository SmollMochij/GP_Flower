...
bool Renderer::SetupSpriteShader()
{
	...
	bool loaded = m_pSpriteShader->Load("sprite.vert", "sprite.frag");
	...
	m_pSpriteVertexData = new VertexArray(vertices, 4 /*num_vertices*/, indices, 6 /*len(indices)*/);
	return loaded;
}
